...
const GallerySection = () => {
    ...
    return (
        <div>
            <div>
                <h1 className='text-center font-bold text-4xl text-amber-400 mt-14'>Our Best & Popular Selling Toys</h1>
                <p className='text-center text-amber-400 font-bold mb-14'>All of our toys are made from sustainably</p>
            </div>
